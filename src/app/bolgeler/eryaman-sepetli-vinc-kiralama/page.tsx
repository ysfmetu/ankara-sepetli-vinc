            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  Site içi ağaç budama operasyonlarında yüksek ağaçlara tırmanarak işlem yapmak hem belediyenin iş güvenliği standartlarına aykırıdır hem de personelin can güvenliğini direkt olarak tehlikeye atar. Özellikle Eryaman'a çok yakın konumda bulunan ve müstakil yaşamın merkezi olan villa bölgelerinde (örneğin Bağlıca bağlantısı üzerinden ulaştığımız elit konut projelerinde) peyzajın dokusuna zarar vermeden budama yapmak şarttır. Bağlıca ve Eryaman çevresindeki villa ve site alanlarında yapılan budama işlemlerinde benzer operasyonları uyguluyoruz. Detaylı bilgi için <Link href="/blog/baglica-villa-bolgesinde-agac-budama-calismasi" className="font-semibold underline text-teal-700 hover:text-teal-900 transition-colors">Bağlıca ağaç budama çalışması</Link> yazımızı inceleyebilirsiniz. Vinç sepetinden motorlu testereyle ağaca yaklaşan operatör, ağır dalları yavaşça ve kontrollü bir şekilde yere indirir. Bu modern yöntem hem operasyonel bir güvenlik avantajı sağlar hem de çalışmayı dakikalar içinde bitirir.
                </p>
              </div>
            </div>
          </div>
