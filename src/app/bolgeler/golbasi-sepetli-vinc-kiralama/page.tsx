...
export const metadata: Metadata = {
  ...
  description:
    'Ankara Gölbaşı ve İncek bölgesinde villa bahçesi ağaç budama, peyzaj ve dış cephe işlemleri için 7/24 operatörlü, yüksek güvenlikli sepetli vinç kiralama.',
  ...
  openGraph: {
    ...
    description:
      'Ankara Gölbaşı ve İncek bölgesinde villa bahçesi ağaç budama, peyzaj ve dış cephe işlemleri için 7/24 sepetli vinç kiralama. Hemen Arayın: 0551 606 68 78',
    ...
    '@graph': [
      {
        ...
        description:
          "Gölbaşı ve İncek'te villa cephe onarımları, peyzaj, yüksek ağaç budama ve sepetli vinç hizmetleri.",
        url: getCanonicalUrl('/bolgeler/golbasi-sepetli-vinc-kiralama'),
      },
      {
        '@type': 'LocalBusiness',
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="prose prose-lg text-gray-200 mb-10 max-w-3xl font-light">
                <p>
                  <strong>Türkiye’nin başkenti Ankara</strong>, son yıllarda lüks yaşam alanlarının
                  doğaya doğru genişlediği devasa bir yerleşim planına sahiptir.{' '}
                  <strong>İç Anadolu Bölgesi</strong>'nin en kıymetli sulak alanlarına ev sahipliği
                  yapan ve <strong>Ankara’nın güneyinde yer alan Gölbaşı</strong>, villa
                  yerleşimleri, lüks site projeleri ve geniş doğal alanları ile başkentin en farklı
                  ve prestijli ilçelerinden biridir. Özellikle İncek, Tulumtaş, Karagedik,
                  Bahçelievler mahalleleri ile Gölbaşı merkez ve Mogan Gölü çevresi bu hızlı konut
                  gelişiminin merkezindedir.
                </p>
                <p>
                  Gölbaşı'nın bu yatay mimariye ve peyzaja dayalı yapısı, sepetli vinç kullanım
                  alanlarını şehir merkezindeki ilçelerden ayırır. İncek ve Tulumtaş'taki devasa
                  müstakil villaların yüksek çatı onarımları, kamera ve güvenlik sistemlerinin
                  montajı veya Mogan çevresinde bulunan geniş bahçelerdeki tehlikeli ağaç budama
                  işleri için vinç kiralama hizmeti büyük bir avantaj sağlar. Geleneksel merdiven
                  veya iskele kurulumunun hem riskli hem de bahçe peyzajına (çimlere vb.) zarar
                  verdiği bu noktalarda{' '}
                  <Link
                  ...
                  sistemimiz, güvenliği en üst düzeye çıkarır. Lüks konutların mimari yapısına zarar
                  vermemek adına %100 iş güvenliği politikamızla{' '}
                  <Link
                ...
                <p>
                  Villa sahipleri ve site yönetimleri genellikle ufak çaplı oluk temizliği veya tek
                  bir ağaç kesimi gibi hızlı müdahaleler için{' '}
                  <Link
                  ...
                  paketimizi tercih etmektedir. Ancak Gölbaşı merkezdeki ticari yapıların cephe
                  giydirme işlemleri veya Karagedik tarafındaki geniş depolama tesislerinin
                  inşasında olduğu gibi uzun soluklu şantiye süreçlerinde bütçeyi optimize eden{' '}
                  <Link
                  ...
                  seçeneğimiz devreye girer. Doğaya ve mimariye saygılı araçlarımızla 7/24
                  hizmetinizdeyiz.
                </p>
              </div>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">
              Gölbaşı’nda Sepetli Vinç En Çok Nerelerde Kullanılır?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-emerald-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  İncek ve çevresindeki lüks villa yerleşimlerinde, müstakil bahçe düzenlemeleri,
                  yüksek çatı izolasyonları, baca temizliği ve ev güvenlik kamera/alarm
                  sistemlerinin montajında estetik ve sessiz çalışma sağlanır.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-emerald-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Mogan ve Eymir Gölü etrafındaki turistik tesisler, restoranlar ve geniş yeşil
                  alanlarda çevre peyzajı, yüksek ağaç budama işlemleri ve park aydınlatmalarının
                  bakımında sepetli vinç kullanılır.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-emerald-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Şehrin yoğunluğundan uzaklaşan Karagedik bölgesinde kurulan yeni fabrika alanları,
                  depo tesisleri ve geniş açık hava inşaat şantiyelerinde vinç yolları ve çatı
                  konstrüksiyon işleri sürdürülür.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-emerald-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Tulumtaş mağarası çevresi ve yeni gelişen site projelerinde kaba inşaat sonrası
                  ince işçilik olan dış cephe boya, mantolama ve yağmur oluğu sistemlerinin
                  çekilmesi için vinç kiralanır.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-emerald-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Gölbaşı'nın ana ticari arterlerinde yer alan esnafların ışıklı tabela montajları,
                  kurumsal logoların asımı ve çok katlı apartmanların cephe yalıtım işlemleri
                  trafiği kilitlemeden vinçlerle gerçekleştirilir.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-2/3 text-center md:text-left">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Gölbaşı’nda Ağaç Budama ve Peyzaj Çalışmaları İçin Vinç
                </h2>
                <div className="prose prose-lg text-gray-700 font-light">
                  <p>
                    Gölbaşı ve İncek bölgelerindeki en büyük taleplerin başında{' '}
                    <strong>bahçe düzenleme</strong> ve <strong>yüksek ağaçlar</strong> için talep
                    edilen budama hizmetleri gelmektedir. Devasa boylara ulaşan çam ağaçları veya
                    kurumuş dallar, rüzgarlı havalarda kırılarak binaların çatılarına, pencerelere
                    ve araçların üzerine düşme tehlikesi yaratır.
                  </p>
                  <p>
                    <strong>Villa alanları</strong> içerisinde veya site bahçelerinde bu ağaçlara
                    geleneksel yöntemlerle (merdivenle çıkılarak vb.) müdahale etmek kesinlikle
                    doğru değildir. Vinç platformu üzerinden motorlu testereyle yapılan{' '}
                    <strong>güvenli kesim</strong> işlemleri, hem bahçenin peyzaj dokusuna (çimlere
                    ve diğer bitkilere) zarar vermez hem de operatör ve işçi güvenliğini %100
                    sağlar. Gölbaşı'nda yeşili koruyan kontrollü budama operasyonları için özel
        ...
        <section className="bg-primary py-12 border-y border-primary-dark">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Gölbaşı’nda en yakın vinci hızlıca yönlendirelim.
            </h3>
            <p className="text-primary-foreground mb-8 text-lg">
              Villa bakımı, ağaç budama veya tabela işleriniz için iskele kurarak vakit kaybetmeyin.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-sm border border-gray-200 max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Gölbaşı Sepetli Vinç Fiyatları
              </h2>
              <div className="prose prose-gray max-w-none mb-8 text-left">
                <p className="text-lg">
                  Gölbaşı, coğrafi olarak oldukça geniş bir yüzölçümüne sahiptir. Bu nedenle vinç
                  kiralama fiyatlarını belirlerken işin yapılacağı bölgenin şehir merkezine olan
                  uzaklığı, yani <strong>mesafe</strong> doğrudan <strong>fiyatı etkiler</strong>.
                  Ancak diğer ilçelerdeki dar sokakların aksine Gölbaşı ve İncek bölgesindeki yollar
                  ve <strong>geniş alanlar</strong> aracın kurulumu ve manevrası için büyük{' '}
                  <strong>avantaj</strong> sağladığından, çalışma çok daha hızlı başlar ve işçilik
                  süresinden tasarruf edilir.
                </p>
                <p className="text-lg">
                  Ayrıca yapılacak işin niteliği de maliyet analizinde kritiktir. Örneğin standart
                  bir <strong>villa</strong> bahçesindeki kamera montajı işi sadece birkaç saat
                  sürerken, devasa bir çam ağacının tepeden tırnağa tehlikesizce budanması ve
                  parçaların aşağı alınması işlemlerinin <strong>süresi değişir</strong>.
                </p>
              </div>
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 shadow-sm inline-block w-full">
                <p className="text-gray-900 font-bold mb-4 text-xl">
                  İşinizin fotoğrafını gönderin, net fiyat için arayın.
                </p>
                <div className="flex flex-col sm:flex-row justify-center gap-3">
                  <a
                    href="tel:05516066878"
                    className="inline-flex justify-center items-center gap-2 bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-emerald-700 transition-colors text-lg"
                  >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Gölbaşı’nda Gerçekleştirdiğimiz Vinç Çalışmaları
              </h2>
              <p className="text-lg text-gray-600">
                İncek ve Gölbaşı projelerinde doğaya ve çevreye zarar vermeden tamamladığımız bazı
                operasyonlar.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    İncek'te yer alan müstakil bir villanın bahçesinde bulunan ve rüzgardan
                    kırılarak çatıya yaslanmış 15 metrelik kavak ağacı, peyzaj çimlerine zarar
                    vermeden vincimiz yardımıyla yukarıdan aşağıya güvenle kesilerek budandı.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Tulumtaş mevkiinde yeni inşa edilen çok bloklu bir lüks konut projesinde, iskele
                    söküldükten sonra fark edilen dış cephe boya hataları ve yağmur oluğu
                    eksiklikleri sepetli platformlar kullanılarak hızlıca giderildi.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Gölbaşı merkezde, Konya yolu güzergahı üzerinde yer alan ticari bir mağazanın 8
                    metre yüksekliğindeki yeni ışıklı kurumsal totem tabelasının montajı, ana trafik
                    akışını durdurmadan başarıyla uygulandı.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Gölbaşı’nda Sunulan Vinç Hizmetleri
              </h2>
              <p className="text-lg text-gray-600">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <Link
                href="/hizmetler/sepetli-vinc-kiralama"
                className="bg-white border border-gray-200 p-5 rounded-xl hover:border-emerald-500 hover:shadow-md transition-all flex flex-col group"
              >
                <span className="font-bold text-gray-800 group-hover:text-emerald-600 transition-colors text-lg mb-2">
                  Sepetli Vinç
                </span>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Gölbaşı ve İncek bölgelerindeki operasyonlar hakkında merak edilen detaylar.
              </p>
            </div>
