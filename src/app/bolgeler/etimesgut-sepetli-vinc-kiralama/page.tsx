...
export const metadata: Metadata = {
  ...
  description:
    'Etimesgut, Bağlıca ve Elvankent bölgelerinde sepetli vinç kiralama hizmeti. 30 dakikada adresinize ulaşım sağlayan uygun fiyatlı ve operatörlü vinç seçenekleri.',
  ...
  openGraph: {
    ...
    description:
      'Etimesgut, Eryaman, Bağlıca ve Elvankent bölgelerinde sepetli vinç kiralama hizmeti. 30 dakikada adresinize ulaşım, operatörlü vinç desteği ve uygun fiyat avantajı için hemen arayın: 0551 606 68 78',
