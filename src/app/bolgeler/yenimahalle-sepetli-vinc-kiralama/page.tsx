  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow">
        <div className="bg-gray-50 py-16 md:py-24 border-b border-gray-200">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6">
              Yenimahalle <span className="text-primary">Sepetli Vinç Kiralama</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600">
              Araç filomuzun merkezi olan Yenimahalle&apos;de en hızlı, en uygun fiyatlı sepetli
              platform çözümleri.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-4xl">
          <div className="prose prose-lg prose-red max-w-none text-gray-700">
            <p className="lead font-medium text-xl text-gray-700">
              Ankara Yenimahalle bölgesi ve çevresinde yılların deneyimiyle en hızlı, en güvenli sepetli vinç kiralama hizmetini sunuyoruz. Geniş makine parkurumuz sayesinde 10 metreden 70+ metreye kadar tüm yükseklik ihtiyaçlarınıza aynı gün çözüm üretiyoruz.
            </p>
            ...
            <div className="space-y-4 not-prose mt-6 mb-8">
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                <h4 className="font-bold text-gray-900 mb-2">Yenimahalle bölgesine ne kadar sürede araç gönderebilirsiniz?</h4>
        ...
        <CallToAction
          title="Yenimahalle Bölgesinde Anında Sevk Seçeneği"
          message="Merhaba, Yenimahalle'de sepetli vinç ihtiyacımız var, fiyat alabilir miyim?"
        />
      </main>
