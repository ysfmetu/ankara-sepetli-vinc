...
export const metadata: Metadata = {
  ...
  description:
    'Ankara Yenimahalle, Batıkent ve Şentepe bölgelerinde 7/24 operatörlü sepetli vinç kiralama. Dış cephe tamiratı ve tabela montajı için hemen destek alın.',
  alternates: getMetadataAlternates('/bolgeler/yenimahalle-sepetli-vinc-kiralama'),
  openGraph: {
    title: 'Yenimahalle Sepetli Vinç Kiralama | Batıkent ve Ostim',
    description:
      "Ankara Yenimahalle'de Ostim sanayi bölgesi fabrika bakımları, Batıkent site işleri ve Demetevler dar sokak cephe işleri için sepetli vinç kiralama. Arayın: 0551 606 68 78",
    ...
    '@graph': [
      {
        ...
        description:
          "Yenimahalle'de Batıkent, Ostim, İvedik ve Demetevler bölgeleri için fabrika bakımı, site onarımı ve dar sokak vinç hizmetleri.",
        url: getCanonicalUrl('/bolgeler/yenimahalle-sepetli-vinc-kiralama'),
      },
      {
        '@type': 'LocalBusiness',
      ...
      <main className="flex-grow pt-24 pb-0">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
                Yenimahalle’de Sepetli Vinç Nerelerde Kullanılır?
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Sanayi, Site ve Apartman blokları olmak üzere üç ana kolda uzmanlaşmış vinç
                çözümleri.
              </p>
            </div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Üretim tesislerinin dış cephe panelleri ve izolasyon tamiratları.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Büyük CNC tezgahlarının üst havalandırma ve tesisat bağlantıları.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Yüksek lojistik depolarında armatür ve LED değişim işlemleri.
                      </span>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-4 relative z-10 mt-6">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Çok katlı blokların boya, mantolama ve oluk tamir işlemleri.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Site içerisindeki tehlike arz eden büyük çam ve ağaçların kesimi.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Çatı izolasyonu, uydu anteni montajı ve kamera sistemleri.
                      </span>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-4 relative z-10 mt-6">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Kısa şaseli araçlarla trafiği felç etmeden yapılan çalışmalar.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Zemin katta yer alan dükkanların üstlerine reklam panosu asımı.
                      </span>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 text-sm">
                        Balkon altı sıva dökülmeleri, baca temizliği ve klima sökümü.
                      </span>
                    </div>
                  </li>
                </ul>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-sm border border-gray-200 max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Yenimahalle Sepetli Vinç Fiyatları
              </h2>
              <div className="prose prose-gray max-w-none mb-8 text-left">
                <p className="text-lg">
                  Yenimahalle sınırları içerisindeki vinç kiralama fiyatları, işin niteliğine göre
                  şekillenir. Ostim ve İvedik bölgesindeki fabrikalarda yapılan montaj veya üretim
                  revizyonu işleri uzun sürdüğü için{' '}
                  <strong>sanayi işleri günlük olarak fiyatlandırılır</strong> ve ekonomik avantaj
                  sağlanır.
                </p>
                <p className="text-lg">
                  ...
                  <strong>fiyatı etkiler</strong>. Projeniz için size özel çözümler sunuyoruz.
                </p>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 shadow-sm inline-block w-full">
                <p className="text-gray-900 font-bold mb-4 text-xl">
                  İşinizin net bütçesini öğrenmek için bizi arayın.
                </p>
        ...
        <section className="py-20 bg-gray-50 border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
                Yenimahalle’de Gerçekleştirdiğimiz Vinç Çalışmaları
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Dış ünite montajı için gerçekleştirilen 1 saatlik güvenli sepetli vinç saha
                    operasyonunun detayları.
                  </p>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Onkoloji Hastanesi yakınında bulunan diş kliniğinde 27 metre sepetli vinç ile
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    ...
                    gerçekleştirilen cephe kaplama çalışması.
                  </p>
                  <span className="mt-4 inline-flex items-center gap-1 text-blue-600 font-semibold text-sm group-hover:gap-2 transition-all">
                    Operasyonu İncele <ChevronRight size={16} />
                  </span>
              ...
              {/* Kart 4 — Ragıp Tüzün Caddesi Tabela Sökümü */}
              <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm flex flex-col">
                <div className="relative h-52 w-full overflow-hidden">
                  <Image
                    src="/images/blog/ankara-sepetli-vinc-kiralama-yenimahalle-tabela-sokumu.jpg"
                    alt="Yenimahalle Ragıp Tüzün Caddesi'nde sepetli vinç ile tabela sökümü"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="bg-gray-700 px-5 py-3 flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-gray-200 uppercase tracking-widest">
                    Yenimahalle · Ragıp Tüzün Caddesi
                  </span>
                </div>
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-gray-900 mb-2 leading-snug">
                    Ragıp Tüzün Caddesi&apos;nde Riskli Tabela Sökümü
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Ragıp Tüzün Caddesi üzerindeki bir işletmede devrilme riski oluşturan yüksek
                    tabela, sepetli vinç desteğiyle kontrollü şekilde sökülerek güvenli biçimde
                    indirildi.
                  </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Yenimahalle’de Sunulan Vinç Hizmetleri
              </h2>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Yenimahalle, Batıkent ve Ostim çevresindeki operasyonlarla ilgili detaylar.
              </p>
            </div>
