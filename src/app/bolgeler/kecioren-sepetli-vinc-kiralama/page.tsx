...
export const metadata: Metadata = {
  ...
  description:
    'Ankara Keçiören, Ovacık ve Etlik bölgelerinde dar sokaklara girebilen araç üstü platformlarımızla 7/24 operatörlü sepetli vinç kiralama hizmeti sunuyoruz.',
  ...
  openGraph: {
    ...
    description:
      "Ankara Keçiören'de Etlik, İncirli ve Ovacık bölgelerinde dar sokaklar ve yoğun trafik için hızlı sepetli vinç kiralama. Hemen Arayın: 0551 606 68 78",
    ...
    '@graph': [
      {
        ...
        description:
          "Keçiören'de Etlik, İncirli ve merkez mahallelerinde apartman cephe, tabela montaj ve ağaç budama vinç kiralama hizmetleri.",
        url: getCanonicalUrl('/bolgeler/kecioren-sepetli-vinc-kiralama'),
      },
      {
        '@type': 'LocalBusiness',
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      <main className="flex-grow pt-24 pb-0">
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="prose prose-lg text-gray-200 mb-10 max-w-3xl font-light">
                <p>
                  <strong>Türkiye’nin başkenti Ankara</strong>, durmaksızın gelişen mimarisi ve
                  yüksek nüfusu ile <strong>İç Anadolu Bölgesi</strong>'nin en hareketli
                  metropolüdür. Bu metropol yapının içerisinde, nüfus sayımı verilerine göre{' '}
                  <strong>Ankara’nın en kalabalık ilçelerinden biri olan Keçiören</strong>, bitişik
                  nizam konut yapısı ve milyonluk nüfusuyla inanılmaz bir sirkülasyona sahiptir.
                  Etlik, İncirli, Kalaba, Ufuktepe, Ovacık ve Keçiören merkez başta olmak üzere, bu
                  devasa ilçede yaşamın devamlılığı için altyapı ve üstyapı bakım işlemleri hiçbir
                  zaman durmaz.
                </p>
                <p>
                  Keçiören'in bu yüksek yoğunluklu kent dokusu; cadde esnaflarının tabela montajı,
                  eski apartmanların dış cephe temizliği, bina bakım onarım işleri ve arıza veren
                  elektrik aydınlatmalarının onarımı gibi yüksekte çalışma gerektiren işlemlerin
                  sürekliliğini mecburi kılar. Bu gibi sirkülasyonu yüksek ve trafikli bölgelerde
                  sepetli vinç kiralama hizmeti sıradan bir iş olmaktan çıkıp; hızlı, saatlik olarak
                  planlı ve en doğru kompakt araç seçimi ile yönetilmesi gereken bir mühendislik
                  işine dönüşür. İşin güvenliğini ve çevre sakinlerinin sağlığını korumak adına tüm
                  operasyonlarda{' '}
                  <Link
                  ...
                  sistemimiz tam donanımlı olarak çalışır. Riske mahal vermemek için %100{' '}
                  <Link
                ...
                <p>
                  Vatandaşların günlük yaşamını aksatmadan, cadde üzerindeki bir mağaza camı
                  değişimi veya bir apartman bacası temizliği için çok daha pratik olan{' '}
                  <Link
                  ...
                  modeli ilçede en çok tercih edilen kiralama türüdür. Öte yandan, kentsel dönüşümle
                  inşa edilen yeni Ovacık sitelerinin boya, izolasyon ve cam montajı gibi daha
                  kapsamlı ve günlerce sürecek şantiye süreçleri için uygun bütçeli{' '}
                  <Link
                  ...
                  imkanımız da bulunmaktadır. Keçiören'in hızına ve yoğunluğuna anında cevap veren
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-900">
              Keçiören’de Sepetli Vinç En Çok Nerelerde Kullanılır?
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-blue-500 transition-colors group">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">
                  Apartman Cephe İşleri
                </h3>
                <p className="text-gray-600">
                  Özellikle İncirli ve Etlik gibi eski yerleşim yerlerindeki çok katlı binalarda
                  dökülen sıvaların onarımı, yağmur oluklarının değiştirilmesi ve yüksek katlara
                  eşya çekimi gibi apartman cephe işlerinde sıklıkla kiralama yapılır.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-blue-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Nüfusun yoğun olduğu Keçiören merkez, Fatih ve Sanatoryum Caddesi gibi ana
                  arterlerde yer alan esnafların ışıklı reklam panolarının, mağaza cephe
                  giydirmelerinin sökülüp takılması işleri için şarttır.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-blue-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  İskele kurulumunun günlerce sürebildiği ve çevre esnafı rahatsız edebildiği
                  durumlarda, eski binaların dış mantolama, izolasyon yenileme ve dış cephe boya
                  işlemleri araç üstü platformlardan hızla bitirilir.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-blue-500 transition-colors group">
                ...
                <p className="text-gray-600">
                  Kalaba ve çevresindeki parklarda veya eski binaların bahçelerinde yer alan,
                  uzayarak elektrik tellerine değen veya fırtınada çatıya düşme tehlikesi bulunan
                  dev kavak ve çam ağaçlarının kontrollü kesimini sağlar.
                </p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl hover:border-blue-500 transition-colors group">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors">
                  Elektrik Bakım Çalışmaları
                </h3>
                <p className="text-gray-600">
                  Bölgedeki cadde aydınlatma direklerinin LED dönüşümleri, park aydınlatmalarının
                  onarımı ve trafo direklerindeki yüksek gerilim tamiratları esnasında yalıtımlı
                  sepetlerimizle tam güvenlik sağlanır.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-2/3 text-center md:text-left">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">
                  Keçiören’de Yoğun Yapılaşma ve Vinç Kullanımı
                </h2>
                <div className="prose prose-lg text-gray-700 font-light">
                  <p>
                    Keçiören; milyonluk <strong>yüksek nüfus</strong> profili, çok katlı bitişik
                    apartman blokları ve dar arnavut kaldırımlı eski sokaklarıyla tam bir metropol
                    dokusuna sahiptir. Bu fiziki yapı; herhangi bir dış cephe çalışmasını veya
                    onarımını son derece riskli ve karmaşık hale getirir. İki binanın birbirine
                    yapışık olduğu <strong>dar sokaklar</strong>, devasa tonajlı iş makinelerinin bu
                    alanlara girmesini imkansız kılar.
                  </p>
                  <p>
                    Bu engelleri aşmak için en önemli kriter doğru araç seçimidir. Araç filomuzda
                    yer alan kısa şaseli (dingil açıklığı az) ve dar alanlarda denge ayaklarını
                    asimetrik açabilen kompakt sepetli platformlarımızla, yolları tamamen kapatmadan
                    çalışıyoruz. <strong>Yoğun trafik</strong> akışını durdurmadan yapılan bu
                    operasyonlarda <strong>hızlı müdahale ihtiyacı</strong> temel ilkemizdir. Uzman
                    operatörlerimiz sayesinde Keçiören'in en dik ve dar mahallelerinde bile en
                    hızlı, en güvenli çözümü saniyeler içinde üretiyoruz.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-primary py-12 border-y border-primary-dark">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Keçiören’de en yakın vinci hızlıca yönlendirelim.
            </h3>
            <p className="text-primary-foreground mb-8 text-lg">
              Dar sokaklara ve yoğun trafiğe uygun araçlarımızla hemen müdahale ediyoruz.
            </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gray-50 p-8 md:p-12 rounded-3xl shadow-sm border border-gray-200 max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Keçiören Sepetli Vinç Fiyatları
              </h2>
              <div className="prose prose-gray max-w-none mb-8 text-left">
                <p className="text-lg">
                  Keçiören bölgesindeki vinç kiralama maliyetlerini optimize eden en önemli faktör
                  lojistik yakınlıktır. Merkezimize olan <strong>kısa mesafe</strong> maliyet
                  açısından müşterilerimiz için ciddi bir <strong>avantaj</strong> yaratır. Ancak
                  sadece ulaşım değil, çalışma yapılacak alanın fiziki durumu da fiyatlandırmayı
                  etkiler.
                </p>
                <p className="text-lg">
                  Aracı kurmanın zor olduğu, park halindeki araçlar yüzünden vincin denge
                  ayaklarının açılamadığı <strong>dar alan</strong> işlemleri operasyonel{' '}
                  <strong>zorluk</strong> ve ekstra dikkat gerektirdiği için işin yapılışını
                  yavaşlatabilir. Bu noktada sepetli platformun kullanılacağı toplam kullanım{' '}
                  <strong>süresi</strong> (saat veya gün) genel <strong>fiyatı belirler</strong>.
                  Ufak bir cephe onarımı ile tüm binanın boyanması bütçe olarak farklılık
                  gösterecektir.
                </p>
              </div>
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 shadow-sm inline-block w-full">
                <p className="text-gray-900 font-bold mb-4 text-xl">
                  İşinize özel net fiyat için hemen arayın.
                </p>
                <div className="flex flex-col sm:flex-row justify-center gap-3">
                  <a
                    href="tel:05516066878"
                    className="inline-flex justify-center items-center gap-2 bg-blue-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors text-lg"
                  >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Keçiören’de Sunulan Vinç Hizmetleri
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <Link
                href="/hizmetler/sepetli-vinc-kiralama"
                className="bg-white border border-gray-200 p-5 rounded-xl hover:border-blue-500 hover:shadow-md transition-all flex flex-col group"
              >
                <span className="font-bold text-gray-800 group-hover:text-blue-600 transition-colors text-lg mb-2">
                  Sepetli Vinç
                </span>
        ...
        {/* 8.5 Son Gerçek Saha Çalışmalarımız — 3 kart, Halkbank en başta */}
        <section className="py-16 bg-gray-50 border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Keçiören&apos;de Gerçekleştirdiğimiz Saha Çalışmaları
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                İlçenin dar sokaklarında ve işlek caddelerinde başarıyla tamamladığımız gerçek
                operasyonlar — tüm detaylarıyla.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {/* Kart 1 — Halkbank Cam Temizliği (EN YENİ) */}
              <Link
                href="/blog/kecioren-ovacik-halkbank-dis-cephe-cam-temizligi"
                className="group bg-white border-2 border-blue-500 rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:border-blue-600 transition-all flex flex-col"
              >
                <div className="relative h-52 w-full overflow-hidden">
                  <Image
                    src="/images/blog/kecioren-ovacik-halkbank-dis-cephe-cam-temizligi-calisma.jpg"
                    alt="Keçiören Ovacık Halkbank Şubesi dış cephe cam temizliği — 27 metre sepetli vinç"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute top-3 left-3 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide shadow">
                    Son Çalışma
                  </div>
                </div>
                <div className="bg-blue-600 px-5 py-3 flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-blue-100 uppercase tracking-widest">
                    Keçiören · Ovacık · Halkbank
                  </span>
                </div>
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors leading-snug">
                    Halkbank Şubesi Dış Cephe Cam Temizliği
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Ovacık Halkbank Şubesi&apos;nde 27 metre sepetli vinç ile gerçekleştirilen dış
                    cephe cam temizliği. Yaklaşık 3 saatte sorunsuz tamamlandı.
                  </p>
              ...
              >
                <div className="relative h-52 w-full overflow-hidden">
                  <Image
                    src="/images/blog/ankara-sepetli-vinc-kiralama-kecioren-etlik-dis-cephe-calismasi-1.jpg"
                    alt="Keçiören Etlik dış cephe tamiratı — 27 metre Ankara sepetli vinç"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors leading-snug">
                    Etlik&apos;te Dış Cephe Tamiratı Çalışması
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Etlik bölgesinde 27 metre sepetli vinç ile gerçekleştirilen dış cephe tamiratı.
                    2 saatte güvenle tamamlandı.
                  </p>
                  <span className="mt-4 inline-flex items-center gap-1 text-blue-600 font-semibold text-sm group-hover:gap-2 transition-all">
                    Operasyonu İncele <ChevronRight size={16} />
                  </span>
              ...
              >
                <div className="relative h-52 w-full overflow-hidden">
                  <Image
                    src="/images/blog/ovacik-tabela-ankarasepetlivinc.jpeg"
                    alt="Keçiören Ovacık tabela montajı sepetli vinç"
                    fill
                    className="object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors leading-snug">
                    Ovacık&apos;ta Tabela Montajı Çalışması
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed flex-1">
                    Keçiören Ovacık bölgesinde 4 saat içerisinde tamamlanan kurumsal tabela montajı
                    operasyonu.
                  </p>
                  <span className="mt-4 inline-flex items-center gap-1 text-blue-600 font-semibold text-sm group-hover:gap-2 transition-all">
                    Operasyonu İncele <ChevronRight size={16} />
            ...
            <p className="text-center text-gray-500 mt-10 max-w-3xl mx-auto text-sm leading-relaxed">
              Keçiören&apos;in Ovacık, Etlik, Ayvalı, Aktepe, Yükseltepe, Ufuktepe ve çevre
              mahallelerinde gerçekleştirdiğimiz gerçek saha çalışmalarını inceleyerek hizmet
              süreçlerimiz hakkında detaylı bilgi alabilirsiniz.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Keçiören, Etlik ve İncirli çevresindeki operasyonlarla ilgili merak edilen detaylar.
              </p>
            </div>
