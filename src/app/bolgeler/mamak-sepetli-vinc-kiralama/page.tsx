  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow">
        <div className="bg-gray-50 py-16 md:py-24 border-b border-gray-200">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-6">
              Mamak <span className="text-primary">Sepetli Vinç Kiralama</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600">
              Ankara Mamak bölgesinde yapı, inşaat ve bakım ihtiyaçlarınıza özel
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-4xl">
          <div className="prose prose-lg prose-red max-w-none">
            <p className="lead font-medium text-xl text-gray-700">
              Ankara Mamak bölgesi ve çevresinde yılların deneyimiyle en hızlı, en güvenli sepetli vinç kiralama hizmetini sunuyoruz. Geniş makine parkurumuz sayesinde 10 metreden 70+ metreye kadar tüm yükseklik ihtiyaçlarınıza aynı gün çözüm üretiyoruz.
            </p>
            ...
            <div className="space-y-4 not-prose mt-6 mb-8">
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                <h4 className="font-bold text-gray-900 mb-2">Mamak bölgesine ne kadar sürede araç gönderebilirsiniz?</h4>
        ...
        <CallToAction
          title="Mamak Bölgesi İçin Vinç Çağırın"
          message="Merhaba, Mamak bölgesi için sepetli vinç kiralama hakkında bilgi almak istiyorum."
        />
      </main>
