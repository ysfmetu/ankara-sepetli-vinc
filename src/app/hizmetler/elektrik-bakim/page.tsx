...
export const metadata: Metadata = {
  title: 'Ankara Elektrik Bakım İçin Sepetli Vinç | Güvenli Vinç Hizmeti',
  description: "Ankara’da elektrik direği, aydınlatma ve altyapı bakım işleri için operatörlü sepetli vinç kiralama hizmeti. Hemen arayın: 0551 606 68 78",
        ...
        <section className="py-16 bg-gray-50 border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-primary max-w-none">
              ...
              <p>
                Modern yerleşim yerleri olan Etimesgut ve Eryaman’da ise yoğun bir site bakım işleri sirkülasyonu vardır. Devasa site yönetimlerinin bahçe aydınlatmaları, çevre duvarı güvenlik kamera kurulumları ve kablo çekimi operasyonlarında <Link href="/bolgeler/etimesgut-sepetli-vinc-kiralama" className="font-semibold underline">Etimesgut sepetli vinç kiralama</Link> ekiplerimiz binaların peyzaj alanlarına zarar vermeden yüksek noktalara ulaşır. Üretim üssü olan Sincan ve Kazan’da da durum farklı değildir; burada fabrika elektrik işleri ve OSB sınırları içindeki trafo bağlantı revizyonlarında dayanıklı, yüksek metrajlı vinçlerimiz kullanılarak işlemler en güvenli şekilde yönetilir. Faaliyet gösterdiğimiz diğer tüm semtleri ve lokasyon detaylarını görmek için <Link href="/bolgeler" className="font-semibold underline">Ankara hizmet bölgeleri</Link> listemize göz atabilirsiniz.
              </p>
            </div>
          </div>
        </section>
