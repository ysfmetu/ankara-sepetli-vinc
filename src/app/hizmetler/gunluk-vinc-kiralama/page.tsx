...
export const metadata: Metadata = {
  ...
  description: 'Ankara’da günlük vinç kiralama hizmeti. Şantiye, cephe, fabrika, depo ve site işleri için operatörlü vinç desteği alın: 0551 606 68 78',
