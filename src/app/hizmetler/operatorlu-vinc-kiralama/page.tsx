        ...
        <section className="py-16 bg-gray-50 border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-primary max-w-none">
              ...
              <p>
                Son olarak, lüks konutların ve peyzaj alanlarının yoğun olduğu Gölbaşı’nda villa, site ve bahçe düzenleme işleri için tehlikeli ağaç budama veya dekoratif çatı onarımları güvenli ekipmanlarımızla sağlanır. Ankara'nın her noktası için hazırladığımız <Link href="/bolgeler">Ankara hizmet bölgeleri</Link> planlamamızı inceleyebilir ve mahallenize uygun güvenli aracı talep edebilirsiniz.
              </p>
            </div>
          </div>
        </section>
