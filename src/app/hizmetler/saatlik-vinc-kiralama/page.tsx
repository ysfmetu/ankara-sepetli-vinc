...
export const metadata: Metadata = {
  ...
  description:
    'Ankara’da kısa süreli işler için saatlik vinç kiralama. Tabela, elektrik, cephe ve bakım işleri için aynı gün hizmet: 0551 606 68 78',
    ...
    '@graph': [
      {
        ...
        description:
          'Ankara’da saatlik vinç kiralama hizmeti ile kısa süreli işleriniz için hızlı ve uygun fiyatlı çözüm. Aynı gün vinç yönlendirme ve operatörlü hizmet.',
        url: getCanonicalUrl('/hizmetler/saatlik-vinc-kiralama'),
      },
      {
        '@type': 'LocalBusiness',
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-10 max-w-3xl font-light">
                Ankara’da kısa süreli işleriniz için saatlik vinç kiralama hizmetiyle hızlı ve uygun
                fiyatlı çözümler sunuyoruz. Aynı gün vinç yönlendirme, deneyimli operatör desteği ve
                bütçe dostu fiyatlandırma ile 1 saatten başlayan esnek kiralama seçenekleri.
              </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto prose prose-lg prose-headings:text-gray-900 prose-p:text-gray-600 prose-a:text-primary max-w-none">
              ...
              <p>
                Ankara gibi trafiği ve iş temposu yoğun bir şehirde, bazen sadece 1 veya 2 saat
                sürecek operasyonlar için tam günlük kiralama ücretleri ödemek bütçenizi gereksiz
                yere yorabilir. İşte bu noktada <strong>saatlik vinç kiralama</strong> sistemimiz
                devreye girer. Tabela sökümü, klima dış ünite montajı, kısa süreli cam silimi, sokak
                lambası değişimi veya ufak çaplı arıza onarımları gibi{' '}
                <strong>kısa süreli işler</strong> için en ekonomik kiralama yöntemidir.
              </p>
              ...
              <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl my-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="m-0 text-gray-600 text-base">
                    Acil müdahale gerektiren durumlarda veya aniden planlanan montaj işlerinde
                    beklemeye tahammülünüz olmadığını biliyoruz. Geniş araç filomuz ve Ankara
                    geneline yayılmış hizmet ağımız sayesinde, bize ulaştığınız anda uygun aracı
                    belirler ve <strong>aynı gün vinç yönlendirme</strong> garantisiyle en kısa
                    sürede sahanıza ulaştırırız. Ankara genelinde özellikle{' '}
                    <Link
                    ...
                    taleplerinde hem sanayi hem konut bölgelerine hızlı hizmet veriyoruz.
                  </p>
                </div>
              </div>

              <h2 id="fiyat-mantigi" className="text-3xl font-bold mb-6">
                Saatlik Fiyat Mantığı Nasıl Çalışır?
              </h2>
              <p>
                Saatlik kiralama sisteminde, aracın şantiyenize veya iş alanınıza ulaşıp kurulumunu
                tamamlamasıyla süreç başlar. <strong>Saatlik fiyat mantığı</strong>, tam yevmiye
                ödemek yerine yalnızca kullandığınız saatin (genellikle minimum 1 veya 2 saat
                başlangıç) ücretini ödemeniz üzerine kuruludur. Vinç modeline, çalışma yüksekliğine
                ve makinenin kat edeceği mesafeye göre hesaplama yapılır. Bu model, özellikle küçük
                işletmeler, reklamcılar ve bireysel kullanıcılar için ciddi bir maliyet avantajı
                yaratır.
              </p>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 text-center my-8">
                <p className="text-lg font-bold text-gray-900 m-0">
                  ...
                  numarasını arayın veya WhatsApp’tan yazın.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-primary py-12">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">
              Kısa Süreli İşleriniz İçin Beklemeyin
            </h3>
            <p className="text-primary-foreground mb-8 text-lg">
              Bir saatlik iş için tam gün ödemeyin. Hemen şimdi bizi arayın, projenize en uygun
              saatlik teklifi sunalım.
            </p>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">
              Diğer Vinç Kiralama Hizmetlerimiz
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link
                href="/hizmetler/sepetli-vinc-kiralama"
                className="group bg-gray-50 border border-gray-200 p-6 rounded-2xl hover:border-primary hover:bg-white hover:shadow-md transition-all flex flex-col h-full"
              >
                ...
                <p className="text-gray-600 text-sm mb-4 flex-grow">
                  Her türlü yüksek erişim işlemi için ideal, manevra kabiliyeti yüksek geniş sepetli
                  platform filomuz.
                </p>
                <span className="text-primary font-semibold text-sm flex items-center gap-1 mt-auto">
                  Sayfaya Git <ArrowRight size={16} />
                </span>
              </Link>
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-4 flex-grow">
                  İş güvenliği sertifikalı, profesyonel operatörlerimiz eşliğinde garantili ve
                  güvenli sepetli vinç hizmeti.
                </p>
                <span className="text-primary font-semibold text-sm flex items-center gap-1 mt-auto">
                  Sayfaya Git <ArrowRight size={16} />
                </span>
              ...
              >
                ...
                <p className="text-gray-600 text-sm mb-4 flex-grow">
                  Uzun süren dış cephe çalışmaları, şantiye işleri ve detaylı peyzaj düzenlemeleri
                  için ekonomik günlük kiralama seçenekleri.
                </p>
                <span className="text-primary font-semibold text-sm flex items-center gap-1 mt-auto">
                  Sayfaya Git <ArrowRight size={16} />
                </span>
        ...
        <section className="bg-gray-900 py-16 text-center text-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Aynı Gün İçinde İşinizi Halledelim
            </h2>
            <p className="text-gray-400 mb-10 text-lg max-w-2xl mx-auto">
              Saatlik vinç kiralama avantajlarıyla hızlı, güvenilir ve uygun fiyatlı çözüme ulaşmak
              için çağrı merkezimiz 7/24 hizmetinizde.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="tel:05516066878"
