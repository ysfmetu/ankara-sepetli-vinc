        ...
        <div className="bg-blue-50 border border-blue-100 p-6 md:p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 hover:shadow-md transition-shadow">
          <div className="flex-1">
            ...
            <p className="text-gray-700 text-base md:text-lg">
              <span className="font-semibold text-gray-900">Keçiören Etlik:</span> Dış cephede oluşan hasar, 27 metre sepetli vinç desteğiyle yaklaşık 2 saatte güvenli şekilde tamir edildi. Alan güvenliği sağlanarak ekip cepheye erişti ve bina yönetimine teslim edildi.
            </p>
          </div>
          <Link 
        ...
        <div className="bg-gray-50 border border-gray-200 p-6 md:p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 hover:shadow-md transition-shadow">
          <div className="flex-1">
            <p className="text-gray-600 text-base md:text-lg">
              <span className="font-semibold text-gray-800">Altındağ Örnek Mahallesi:</span> Kentsel dönüşüm alanındaki yüksek katlı binaya 27 metre sepetli vinç ile devasa güvenlik ve reklam brandası montajı tamamlandı.
            </p>
          </div>
          <Link 
