        ...
        <div className={`flex items-center justify-between transition-all duration-250 ease-in-out ${isScrolled ? 'h-[60px]' : 'h-[72px] md:h-20'}`}>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden md:block">WhatsApp'tan Yazın</span>
            ...
            <a
              ...
              className={`hidden md:flex items-center gap-2 bg-primary hover:bg-primary-hover text-white rounded-full font-bold transition-all duration-300 min-h-[44px] justify-center ${isScrolled
                ? 'px-4 py-1.5 text-sm shadow-sm'
                : 'px-5 py-2.5 text-sm lg:text-base shadow-md hover:shadow-lg'
                }`}
            >
